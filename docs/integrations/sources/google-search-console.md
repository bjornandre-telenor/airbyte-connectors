...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.0.4 | 2026-06-05 | [](https://github.com/airbytehq/airbyte/pull/) | Handle 403 "Search Analytics load quota exceeded" as rate-limited (retryable) instead of config error |
